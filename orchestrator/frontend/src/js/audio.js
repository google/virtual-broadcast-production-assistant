...
async function startAudioPlayerWorklet() {
  ...
  const pcmPlayerProcessorUrl = new URL(
    './pcm-player-processor.js',
    import.meta.url
  );

  await audioPlayerContext.audioWorklet.addModule(pcmPlayerProcessorUrl);
...
async function startAudioRecorderWorklet(handler) {
  ...
  const pcmRecorderProcessorUrl = new URL(
    './pcm-recorder-processor.js',
    import.meta.url
  );

  await audioRecorderContext.audioWorklet.addModule(pcmRecorderProcessorUrl);

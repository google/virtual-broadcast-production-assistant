...
def get_default_skills() -> List[AgentSkill]:
    ...
    return [
        AgentSkill(
            id="sofie_rundown_management",
            name="Sofie Rundown Management",
            description="Running and managing rundowns in the Sofie application",
            tags=["sofie", "rundown", "episode", "management", "edit"],
